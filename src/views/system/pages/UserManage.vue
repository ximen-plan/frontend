<template>
  <div>
    ...
    <div class="table">
      ...
      <el-button @click="exportUserInfo">导出用户信息</el-button>
      <el-table
        :data="tableData"
        :stripe="true"
        style="width: 100%"
      >
        ...
        <el-table-column prop="sex" :formatter="formatSex" label="性别" width="180" />
        <el-table-column prop="email" label="邮箱" />
        <el-table-column prop="mobile" label="电话" />
        <el-table-column prop="status" :formatter="(row,cloumn,cellValue) => cellValue == 0 ? '锁定' : '有效'" label="状态" />
    ...
    <div>
      ...
      >
        ...
        <div class="editUser-body">
          <el-form ref="editForm" :model="editForm" status-icon label-width="150px">
            <el-form-item label="用户名:" prop="pass">
              <el-input v-model="editForm.username" style="width: 320px" />
            </el-form-item>
            <el-form-item label="邮箱:" prop="checkPass">
              <el-input v-model="editForm.email" style="width: 320px" />
            </el-form-item>
            <el-form-item label="手机:" prop="age">
              <el-input v-model.number="editForm.mobile" style="width: 320px" />
            </el-form-item>
            ...
            <el-form-item label="部门:" prop="dept">
              <el-input v-model.number="editForm.dept" style="width: 320px" />
            </el-form-item>
    ...
    <div>
      ...
      >
        ...
        <div class="editUser-body">
          <el-form ref="addForm" :model="addForm" status-icon label-width="150px">
            <el-form-item label="用户名:" prop="pass">
              <el-input v-model="addForm.username" style="width: 320px" />
            </el-form-item>
            <el-form-item label="邮箱:" prop="checkPass">
              <el-input v-model="addForm.email" style="width: 320px" />
            </el-form-item>
            <el-form-item label="手机:" prop="age">
              <el-input v-model.number="addForm.mobile" style="width: 320px" />
            </el-form-item>
            <el-form-item label="角色:" prop="roles">
              <el-select
            ...
            <el-form-item label="部门:" prop="dept">
              <el-input v-model.number="addForm.dept" style="width: 320px" />
            </el-form-item>
            <el-form-item label="状态:" prop="status">
  ...
  methods: {
    ...
    exportUserInfo() {
      userApi
        .exportUserInfo()
        .then(res => {
          const filename = window.decodeURI(res.headers['file-name'])
